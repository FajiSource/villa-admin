...
const colors = {
  ...
  danger: { bg: 'bg-red-100 dark:bg-red-800', text: 'text-red-500 dark:text-red-200' },
...
export default function Toast({ type = 'success', message, onClose }) {
  ...
  return (
    <div className="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800" role="alert">
      <div className={`inline-flex items-center justify-center shrink-0 w-8 h-8 rounded-lg ${color.bg} ${color.text}`}>
        {icon}
